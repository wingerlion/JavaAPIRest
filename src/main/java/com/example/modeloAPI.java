 ...
 */
@WebServlet("/usuarios/*")
public class modeloAPI extends HttpServlet {	
	...
	class Model{
		...
		public Model(String _id, String _nombre, String _APP, String _APM, String _Sexo ) {
			id = _id;
			nombre = _nombre;
			APPaterno = _APP;
			APMaterno = _APM;
	...
	public modeloAPI() {
		...
		_modelsDb.put(id1, 
			new Model(
			 id1,		
			 "gerardo", 
			"davila", "garcia","masculino"));
		
		_modelsDb.put(id2, 
				new Model(
				 id2,		
				 "cinthia", 
				"alagon", "vivanco","femenino"));
